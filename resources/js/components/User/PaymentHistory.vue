            ...
            <div class="columns is-centered">
                <div class="column is-8">
                    <div class="box">
                        ...
                        <div class="has-text-weight-bold subtitle is-4 table-header">PAYMENT HISTORY</div>
                        ...
                        <b-table
                            ...
                            <b-table-column field="remarks" label="Remarks" sortable v-slot="props">
                                {{ props.row.remarks }}
                            </b-table-column>
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/get-payment-histories?${params}`)
                .then(({ data }) => {
                    this.data = [];
