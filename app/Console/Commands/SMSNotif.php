    ...
    public function sendSemaphoreSMS(){
        ...
        if ($enter) {
            foreach ($enter as $user) {
                ...
                $msg = 'Reminders Mr/Mrs. ' . $user->user->lname . ': Your ' . $user->hour . ' hr(s) Park Reservation at ' . $user->park->name . ' will start '. $notifBeforeEntrance->setting_value.' minute(s) from now. Thank You!';
        ...
        if ($exit) {
            foreach ($exit as $user) {
                ...
                $msg = 'Reminders Mr/Mrs. ' . $user->user->lname . ': Your ' . $user->hour . ' hr(s) Park Reservation at ' . $user->park->name . ' will end '. $notifPriorExit->setting_value.' minute(s) from now. Thank You!';
                $contactNo = $user->user->contact_no;
                $remarks = 'EXIT/SMS';
                $recipientName = $user->user->lname . ', ' . $user->user->fname;
